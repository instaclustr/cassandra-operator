...
//import com.instaclustr.common.configuration.ConfigurationProperty;
//import com.instaclustr.events.Type;
//import com.instaclustr.nodeagent.ConfigurationProperties;
//import com.instaclustr.nodeagent.cassandra.backup.CommitLogBackupArguments;
//import com.instaclustr.nodeagent.cassandra.backup.uploader.FilesUploader;
//import com.instaclustr.nodeagent.cassandra.backup.util.GlobalLock;
//import com.instaclustr.nodeagent.common.Directories;
...
//
//    @Inject
//    public CommitLogBackupTask(@ConfigurationProperty(ConfigurationProperties.NODE_SHARED_CONTAINER_ROOT_DIRECTORY) final Path sharedContainerRoot,
//                               @ConfigurationProperty(ConfigurationProperties.CASSANDRA_COMMIT_LOG_BACKUP_DIRECTORY) final Path commitLogArchiveDirectory,
...
//
//            if (! manifest.isEmpty()) {
//                filesUploader.uploadOrFreshenFiles(manifest, new FilesUploader.EventType(Type.COMMITLOG_UPLOAD));
//            }
//        }
//    }
//}
